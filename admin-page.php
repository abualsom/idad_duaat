...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($connect->query($sql) === TRUE) {
        header("Location: http://localhost/idad-duaat/admin-page.php");
        exit;
    } else {
...
<body>
    <h1 class="text-primary">إضافة معلومات المدرس</h1>
...
<!-- الرقم الإداري -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column align-items-start">
    <label class="flex-shrink-0" for="admin_number">الرقم الإداري:</label>
    <input class="m-0" type="text" id="admin_number" name="admin_number" required>
</div>
...
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    ...
    <input class="m-0" type="text" id="teacher_name" name="teacher_name" required>
</div>
...
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    ...
    <input class="m-0" type="number" id="teaching_hours" name="teaching_hours">
</div>

<!-- ساعات الاشراف -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="supervision_hours">ساعات الاشراف:</label>
    <input class="m-0" type="number" id="supervision_hours" name="supervision_hours">
</div>
...
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    ...
    <input class="m-0" type="number" id="total_hours" name="total_hours">
</div>
...
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    ...
    <input class="m-0" type="checkbox" id="halaka_1" name="halaka_1">
</div>

<!-- اتم واجب الحلقة الثانية -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="halaka_2">اتم واجب الحلقة الثانية:</label>
    <input class="m-0" type="checkbox" id="halaka_2" name="halaka_2">
</div>

<!-- اتم واجب الحلقة الثالثة -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="halaka_3">اتم واجب الحلقة الثالثة:</label>
    <input class="m-0" type="checkbox" id="halaka_3" name="halaka_3">
</div>

<!-- اتم واجب الحلقة الرابعة -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="halaka_4">اتم واجب الحلقة الرابعة:</label>
    <input class="m-0" type="checkbox" id="halaka_4" name="halaka_4">
</div>

<!-- الرواتب -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="salary_1">الراتب الأول:</label>
    <input class="m-0" type="number" id="salary_1" name="salary_1" >
</div>

<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="salary_2">الراتب الثاني:</label>
    <input class="m-0" type="number" id="salary_2" name="salary_2" >
</div>

<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="salary_3">الراتب الثالث:</label>
    <input class="m-0" type="number" id="salary_3" name="salary_3" >
</div>

<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="salary_4">الراتب الرابع:</label>
    <input class="m-0" type="number" id="salary_4" name="salary_4" >
</div>

<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="salary_5">الراتب الخامس:</label>
    <input class="m-0" type="number" id="salary_5" name="salary_5" >
</div>

<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="salary_6">الراتب السادس:</label>
    <input class="m-0" type="number" id="salary_6" name="salary_6" >
</div>

<!-- الخصم -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="deduction">الخصم:</label>
    <input class="m-0" type="number" id="deduction" name="deduction" >
</div>

<?php
$total =  $salary_1 + $salary_2 + $salary_3 + $salary_4 + $salary_5 + $salary_6 -  $deduction; 
?>

<!-- المجموع النهائي -->
<div class="text-white text-center p-3 col-lg-6 d-flex gap-2 flex-column text-star">
    <label class="flex-shrink-0" for="final_total">المجموع النهائي:</label>
    <input class="m-0" type="number" id="final_total" name="final_total" value="<?php if(isset($total))  echo $total; ?>" readonly>
</div>
...
<div class="buttons-container">
    ...
    <button type="submit">حذف الاسم</button>
